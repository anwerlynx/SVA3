...
import {
  ...
  CheckCircle2, Users, BookOpen, Phone
} from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    titleAr: "التدريب",
    titleEn: "Training",
    descAr: "التدريب الصناعي والميداني للطلاب",
    descEn: "Industrial and field training for students",
    detailAr: "يوفر المعهد برامج تدريب ميداني وصناعي بالتعاون مع كبرى الشركات والمؤسسات الهندسية. يهدف التدريب لربط الجانب النظري بالتطبيق العملي وإكساب الطلاب الخبرة المهنية اللازمة. يتم التدريب خلال الفترة الصيفية ويشمل تقارير ومتابعة أكاديمية.",
    detailEn: "The institute provides field and industrial training programs in cooperation with major engineering companies and institutions. Training aims to link theory with practice and provide students with necessary professional experience. Training takes place during the summer period and includes reports and academic follow-up.",
  },
  {
    id: "student-affairs",
    icon: UserCog,
...
export default function StudentServices() {
  ...
  return (
    <div className="bg-white dark:bg-neutral-950 overflow-hidden w-full transition-colors duration-300">
          ...
          <AnimatedSection>
            <div className="text-center mb-16" dir={direction}>
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <span className="text-blue-700 font-bold text-sm [font-family:'Almarai',Helvetica]">{language === "ar" ? "خدماتنا" : "Our Services"}</span>
                <div className="w-12 h-1 bg-blue-700 rounded-full" />
              </div>
                  ...
                  <Card className="rounded-2xl border-0 shadow-sm hover:shadow-xl transition-all cursor-pointer h-full group bg-white dark:bg-neutral-900 dark:border-neutral-800">
                    <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                      <div className="w-16 h-16 rounded-2xl bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center group-hover:bg-blue-700 dark:group-hover:bg-blue-600 transition-all">
                        <service.icon className="w-8 h-8 text-blue-700 dark:text-blue-500 group-hover:text-white transition-colors" />
                      </div>
      ...
      {services.map((service, index) => (
        <section key={service.id} id={service.id} className={`py-20 ${index % 2 === 0 ? "bg-blue-50 dark:bg-neutral-900" : "bg-white dark:bg-neutral-950"} transition-colors duration-300`}>
                ...
                <CardContent className="p-8 md:p-12" dir={direction}>
                  <div className="flex flex-col gap-6">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-2xl bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center flex-shrink-0 transition-colors duration-300">
                        <service.icon className="w-7 h-7 text-blue-700 dark:text-blue-500 transition-colors duration-300" />
                      </div>
                    ...
                    <div className="flex items-center gap-2 text-blue-700 dark:text-blue-400 text-sm [font-family:'Almarai',Helvetica]">
      ...
      <section className="py-20 bg-blue-700 dark:bg-blue-900 transition-colors duration-300">
